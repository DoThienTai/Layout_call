                          ...
                          child:ListView(
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: Center(child: Text("Last Month",style: TextStyle( color: Colors.white12,fontFamily: 'Roboto-Light',),)),
                              ),
                              Container(
                                width: 124.w,
                                decoration: BoxDecoration(
                                ...
                                child: Center(child: Text("Custom day",style: TextStyle( color: Colors.white12,fontFamily: 'Roboto-Light',),)),
                              ),
                              GestureDetector(
                                onTap: () {
                                ...
                                child: Container(
                                  ...
                                  child: Center(child: Text("Date Range", style: TextStyle(
                                    color: Colors.white,
                                    fontFamily: 'Roboto-Light',
                                      ),
                                    ),
